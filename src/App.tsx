...
const defaultShifts = [
  {
    start: "2025-01-21T07:00",
    end: "2025-01-21T13:00",
    title: "07:00 - 13:00",
    resource: 2,
    slot: 1,
  },
  ...
  {
    start: "2025-01-21T12:00",
    end: "2025-01-21T18:00",
    title: "12:00 - 18:00",
    resource: 4,
    slot: 2,
  },
  ...
  {
    start: "2025-01-22T07:00",
    end: "2025-01-22T13:00",
    title: "07:00 - 13:00",
    resource: 1,
    slot: 1,
  },
  ...
  {
    start: "2025-01-22T12:00",
    end: "2025-01-22T18:00",
    title: "12:00 - 18:00",
    resource: 3,
    slot: 2,
  },
  ...
  {
    start: "2025-01-23T07:00",
    end: "2025-01-23T13:00",
    title: "07:00 - 13:00",
    resource: 1,
    slot: 1,
  },
  ...
  {
    start: "2025-01-23T12:00",
    end: "2025-01-23T18:00",
    title: "12:00 - 18:00",
    resource: 2,
    slot: 2,
  },
  ...
  {
    start: "2025-01-25T07:00",
    end: "2025-01-25T13:00",
    title: "07:00 - 13:00",
    resource: 1,
    slot: 1,
  },
  ...
  {
    start: "2025-01-25T12:00",
    end: "2025-01-25T18:00",
    title: "12:00 - 18:00",
    resource: 2,
    slot: 2,
  },
...
function App() {
  ...
  const saveEvent = useCallback(
    (event: MbscCalendarEvent) => {
      ...
      event.end = shiftEnd;
      event.title =
        formatDate("HH:mm", start) + " - " + formatDate("HH:mm", end);
  ...
  const myInvalids = useMemo(
    () => [
      {
        start: "2025-01-24T00:00",
        end: "2025-01-24T23:59",
        resource: 4,
        slot: 1,
      },
      {
        start: "2025-01-22T00:00",
        end: "2025-01-22T23:59",
        resource: 2,
        slot: 2,
      },
    ],
  ...
  const handleShiftNotesChange = useCallback(
  ...
  const handleShiftDatesChange = useCallback(
